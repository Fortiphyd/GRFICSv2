#USAGE: sudo python enip_feed1.py out@0x93/1/10=DINT[2] in@0x93/1/11=DINT -a 192.168.95.10
# 
...
class Attribute_valve( device.Attribute ):
    ...
    def __setitem__( self, key, value ):
        self.sock.send('{"request":"write","data":{"inputs":{"product_valve_sp":'+repr(value[0] / 65535.0 * 100.0)+'}}}\n')
